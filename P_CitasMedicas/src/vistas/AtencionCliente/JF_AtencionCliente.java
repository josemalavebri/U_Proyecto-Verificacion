 ...
 * @author conta
 */
public class JF_AtencionCliente extends javax.swing.JFrame implements IReceptorEntityJFrame<AtencionMedica>{
    ...
    public JF_AtencionCliente() {
     ...
     private void mostrarTurnosEnTabla() {
         citasMedicas = managerController.get(AtencionMedica.class);
    }
