...
public class EventoTabla<T> {
    ...
    public void metodoFactor( ManagerController controller, Class<T> c, JTable table,Consumer<T> abrirFormularioEditar , Runnable recargarDatoss){
        GeneralTableModel general = (GeneralTableModel) table.getModel();
       
        ActionListener eventoEliminar = new EventoEliminar( table, controller, recargarDatoss, c);
